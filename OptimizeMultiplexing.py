    ...
    for idx_eps, eps in enumerate(epses):
        ...
        for ix_eta, eta_spin_gate_in in enumerate(eta_spin_gates):
            if idx_eps == 0 and ix_eta == 0:
                # dBS = [0.0001, 0.0002, 0.0003, 0.0004, 0.0005, 0.0006, 0.0007, 0.0008, 0.0009, 0.001, 0.00125, 0.0015, 0.00175, 0.002, 0.00225, 0.0025, 0.00275, 0.003]
                dBS = np.linspace(0.0001, 0.003, 40)
            elif idx_eps == 0 and ix_eta == 1:
                dBS = np.linspace(0.0001, 0.0035, 40)
                # dBS = [0.0001, 0.0002, 0.0003, 0.0004, 0.0005, 0.0006, 0.0007, 0.0008, 0.0009, 0.001, 0.00125, 0.0015, 0.00175,
                #        0.002, 0.00225, 0.0025, 0.00275, 0.003]
            elif idx_eps == 1 and ix_eta == 0:
                # dBS = [0.0001, 0.00015, 0.0002, 0.00025, 0.0003, 0.00035, 0.0004, 0.00045, 0.0005, 0.00055,
                #        0.0006, 0.00065, 0.0007, 0.00075, 0.0008, 0.00085, 0.0009, 0.00095, 0.001, 0.0011, 0.0012, 0.0013, 0.0014]
                dBS = np.linspace(0.0001, 0.0012, 30)
            else:
                dBS = np.linspace(0.0001, 0.0014, 30)
                # dBS = [0.0001, 0.00015, 0.0002, 0.00025, 0.0003, 0.00035, 0.0004, 0.00045, 0.0005, 0.00055,
                #        0.0006, 0.00065, 0.0007, 0.00075, 0.0008, 0.00085, 0.0009, 0.00095, 0.001, 0.0012, 0.0014]
            dBS = [0.0015]
